...
def SSC_DimCustGrpSap(tbname):
    """ อ่านข้อมูลจาก SSC_DimCustGrpSap และบันทึกลง SQL """
    ...
    FROM SSC_DimCustGrpSap
    """

 
    df = read_sql_table(query=query, user=read_user,
                        password=read_password, url=read_url)
...
DF_ReadResultC = SSC_DimCustGrpSap(tbname='SSC_DimCustGrpSap')
