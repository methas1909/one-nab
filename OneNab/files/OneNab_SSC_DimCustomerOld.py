...
def SSC_DimCustomerOld(tbname):
    """ อ่านข้อมูลจาก SSC_DimCustomerOld และบันทึกลง SQL """
...
DF_ReadResultC = SSC_DimCustomerOld(tbname='SSC_DimCustomerOld')
