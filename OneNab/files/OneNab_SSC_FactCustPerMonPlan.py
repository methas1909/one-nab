...
def SSC_SumCustomerPerMonth_Plan(tbname):
    """ อ่านข้อมูลจาก SSC_SumCustomerPerMonth_Plan และบันทึกลง SQL """
    ...
    query = """
          SELECT [YM]
                ...
                ,[Customer]
                ,[CustomerTotal]
                ,[FirstActiveBillingDate]
                ,[FirstBillingMonth]
                ,[FirstBillingMonthCount]
                ,[SellToCustomer]
                ,[ETLLoadData]
                ,GETDATE() AS PYLoadDate
            FROM [STAGE].[dbo].[SSC_SumCustomerPerMonth_Plan]
    """
...
DF_ReadResultC = SSC_SumCustomerPerMonth_Plan(
    tbname='SSC_FactCustPerMonPlan')
