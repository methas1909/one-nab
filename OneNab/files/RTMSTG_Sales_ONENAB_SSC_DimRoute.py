...
query = """
    SELECT Route, TerritoryDistrict, SalesType1, SalesType2, BranchVL, RegionSSC, SubBranch, RouteDesc, RouteDescription, Sector, ETLLoadData, PYLoadDate
    FROM SSC_DimRoute
    """
...
# [END Secret Variable]
tidb_df = read_df 
dbtable = 'Sales_ONENAB_SSC_DimRoute'
